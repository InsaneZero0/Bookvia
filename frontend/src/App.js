...
function ForBusinessPage() {
  ...
  const features = [
    ...
    { icon: '📸', title: language === 'es' ? 'Publica tu trabajo' : 'Publish your work', desc: language === 'es' ? 'Publica fotos de tus instalaciones y trabajos realizados. Genera confianza antes de que el cliente entre por la puerta.' : 'Publish photos of your facilities and past work. Build trust before the client walks in.' },
