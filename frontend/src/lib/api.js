...
export const authAPI = {
  ...
  googleSession: (data) => api.post('/auth/google/session', data),
  createRegistrationSubscription: (data) => api.post('/auth/business/create-subscription', data),
  verifyRegistrationSubscription: (data) => api.post('/auth/business/verify-subscription', data),
